...
## 数据类型 ##
  - 整型
    - **tinyint** &ensp;取值范围: 无符号0 ~ 2⁸-1 &ensp;有符号-2⁷ ~ 2⁷-1 &ensp;存储空间: 1个字节
    - **smallint** &ensp;取值范围: 无符号0 ~ 2¹⁶-1 &ensp;有符号 -2¹⁵ ~ 2¹⁵-1 &ensp;存贮空间: 2个字节
    - **mediumint**  &ensp;取值范围: 无符号0 ~ 2²⁴-1 &ensp;有符号-2²³ ~ 2²³-1 &ensp;存储空间: 3个字节
    - **int** &ensp;取值范围: 无符号0 ~ 2³²-1 &ensp;有符号-2³¹ ~ 2³¹-1 &ensp;存储空间: 4个字节
    - **longint** &ensp;取值范围: 无符号0 ~ 2⁶⁴-1 &ensp;有符号-2⁶³ ~ 2⁶³-1 &ensp;存储空间: 8个字节
  - 浮点数
    - float  存储空间: 4个字节
    - double  存储空间: 8个字节
  - 定点数
