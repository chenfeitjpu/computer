...
- `dump key` 序列化key
- `expire key second` 设置key过期时间，以秒计
- `pexpire key millisecond` 设置key过期时间，以毫秒计
- `expireat key timestamp` 设置key过期时间的时间戳，以秒计
- `pexpireat key millitimestamp` 设置 key过期时间的时间戳，以毫秒计
